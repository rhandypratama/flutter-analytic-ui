      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          FadeSlideTransition(
            ...
            child: 
            dynamicText("Forgot Password", fontWeight: FontWeight.bold, fontSize: 22)
          ),
          const SizedBox(height: kSpaceS),
          FadeSlideTransition(
            animation: animation,
            additionalOffset: 16.0,
            child: dynamicText('Est ad dolor aute ex commodo tempor exercitation proident.', fontSize: 14)
          ),
        ],
      ),
    );
