...
import 'package:analytic/onboarding/screen/pages/community/index.dart';
import 'package:analytic/onboarding/screen/pages/education/index.dart';
import 'package:analytic/onboarding/screen/pages/work/index.dart';
import 'package:analytic/onboarding/screen/widgets/header.dart';
import 'package:analytic/onboarding/screen/widgets/next-page-button.dart';
import 'package:analytic/onboarding/screen/widgets/onboarding-page-indicator.dart';
import 'package:analytic/onboarding/screen/widgets/ripple.dart';
import 'package:analytic/utils/constant.dart';
import 'package:analytic/onboarding/screen/pages/onboarding-page.dart';

class Onboarding extends StatefulWidget {
  final double screenHeight;

  const Onboarding({@required this.screenHeight}) : assert(screenHeight != null);
